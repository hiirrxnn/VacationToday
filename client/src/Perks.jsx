export default function Perks({selected,onChange}){
  ...
  return (
    <div className="gap-2 rounded-lg grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
              <label className="gap-2 border p-4 flex rounded-sm border-gray-800">
              ...
              <label className=" gap-2 border p-4 flex rounded-sm border-gray-800">
                <input type="checkbox" checked={selected.includes('privEnt')} name = "privEnt" onChange={handleCbClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <label className=" gap-2 border p-4 flex rounded-sm border-gray-800">
                <input type="checkbox" checked={selected.includes('verifiedHost')} name = "verifiedHost" onChange={handleCbClick}/>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
